...
public class EuroAccount extends Account {
    ...
    public EuroAccount(Double balance, String accountName, Integer accountNo) {
    ...
    public void calculateBalance() {
        getIncomingOutgoingAccountList().forEach(transaction -> {
            ...
            try {
                Number number = format.parse(new DecimalFormat("##.###").format(transaction.getAmount() / ExchangeRate.EURO));
